...
class AnalysisHistoryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('user', 'text_input', 'analysis_result', 'analysis_source', 'timestamp') # These fields should be read-only
...
class SummarizationHistoryAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ('user', 'text_input', 'summarized_text', 'summarization_source', 'timestamp') # These fields should be read-only
